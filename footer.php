<footer>
    ...
    <!--                        -->
    <!--                        <h3>-->
	<?php //echo carbon_get_theme_option( 'crb_cities_title' . get_lang() ); ?><!--</h3>-->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-4 col-xs-12">
                    <div class="useful-footer-link">
                        ...
                        <div class="map">
							<?php if (get_lang() === '_ro'): ?>
                                <iframe width="100%" height="300" frameborder="0" allowfullscreen="" scrolling="no"
                    ...
                    <div class="adress-footer-link">
                        ...
                        <ul class="adress-data">
                            <li><img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer_icon_1.png"
                                     alt="icon"><a
                                        href="tel:<?php echo clear_phone($phone); ?>"><?php echo $phone; ?></a></li>
<!--                            <li><img src="--><?php //echo get_template_directory_uri(); ?><!--/assets/img/footer_icon_2.png"-->
<!--                                     alt="icon"><a href="mailto:--><?php //echo $mail; ?><!--"-->
<!--                                                   class="footer-mail">--><?php //echo $mail; ?><!--</a></li>-->
                            <li><img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer_icon_3.png"
                                     alt="icon"><?php echo $address; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
